...
describe("MatchFetcher integration test", () => {
  ...
  describe("Match fetcher normal flow", () => {
    it("should call serp API and then return games without spotlight and then store data in redis when existing key TTL is lower than the threshold", async () => {
      ...
      expect(calculateDateDiffsInHours(jsonData[0].reminder_time, jsonData[0].date_time)).toEqual(1);
      expect(calculateDateDiffsInHours(jsonData[1].reminder_time, jsonData[1].date_time)).toEqual(24);
      expect(calculateDateDiffsInHours(jsonData[2].reminder_time, jsonData[2].date_time)).toEqual(1);
      expect(calculateDateDiffsInHours(jsonData[3].reminder_time, jsonData[3].date_time)).toEqual(24);
    ...
    it("should call serp API and then return games with spotlight and then store data in redis when existing key TTL is lower than the threshold", async () => {
      ...
      expect(calculateDateDiffsInHours(jsonData[2].reminder_time, jsonData[2].date_time)).toEqual(1);
      expect(calculateDateDiffsInHours(jsonData[3].reminder_time, jsonData[3].date_time)).toEqual(24);
      expect(calculateDateDiffsInHours(jsonData[4].reminder_time, jsonData[4].date_time)).toEqual(1);
      expect(calculateDateDiffsInHours(jsonData[5].reminder_time, jsonData[5].date_time)).toEqual(24);
